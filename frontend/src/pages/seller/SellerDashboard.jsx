...
const SellerDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setStats(statsRes.data.status || statsRes.data);
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure want to delete this listing")) return;
    try {
    ...
    <>
      ...
      <div className={s.statsGrid}>
        {statCards.map((card, i) => (
          ...
          >
            ...
            <div className={s.statsGrid}>{card.title}</div>
      ...
      <div className={s.widgetsGrid}>
        <div className={s.inquiriesWidget}>
          ...
          <p className={s.widgetSubtitle}>New message from potential buyer.</p>
        ...
        <div className={s.tipsWidget}>
          ...
          <div className={s.tipsList}>
            <div className={s.tipTitleHighViews}>
              <h4 className={s.tipTitleHighViews}>
                <HiOutlineEye size={16} />
                High Views!
              </h4>
              <p className={s.tipTextHighViews}>
                Your listing are trending. Try adding video tours to increase
                interest.
              </p>
            </div>
