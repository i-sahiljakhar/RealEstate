        ...
        <section className={s.heroSection}>
          <div className={s.heroContent}>
            ...
            <p className={s.heroSubtitle}>
              ...
              verified listings, connect with top agents, and a place you'll
              love.
            </p>
          ...
          <div className={s.heroImageContainer}>
            <div className={s.imageWrapper}>
              <img src={banner} alt="not found" className={s.heroImage} />
          ...
          <div className={s.container}>
            <div className={s.processHeader}>
              ...
              <p className={s.processSubtitle}>
                We've simplified the journey of finding your dream home into
                three clear, stress-free step.
              </p>
            </div>
            ...
            <div className={s.footerMainGrid}>
              <div className={s.footerBrand}>
                ...
                <p className={s.brandDesc}>
                  ...
                  premium real estate globally. We make property hunting
                  seamless.
                </p>
              ...
              <div>
                ...
                <ul className={s.footerLinks}>
                  <li className={s.contactInfo}>
                    ...
                    sahiljakhar015@gmail.com
                  </li>
                  <li className={s.contactInfo}>
                    <HiPhone className="text-primary text-xl" /> +91 74****6030
                  </li>
              ...
              <div>
                ...
                <p className={s.newsletterDesc}>
                  Subscribe to get the latest and market insights directly in
                  your inbox
                </p>
